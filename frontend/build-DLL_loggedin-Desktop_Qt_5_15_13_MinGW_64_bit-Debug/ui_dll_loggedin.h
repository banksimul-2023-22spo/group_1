...
public:
    ...
    void setupUi(QDialog *DLL_loggedin)
    {
        ...
        DLL_loggedin->resize(393, 300);
        DLL_loggedin->setMinimumSize(QSize(393, 300));
        DLL_loggedin->setMaximumSize(QSize(393, 300));
        label = new QLabel(DLL_loggedin);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(60, 70, 271, 51));
        QFont font;
        ...
        label_2->setGeometry(QRect(140, 130, 111, 21));
